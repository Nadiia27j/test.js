...
//     orderedItems.forEach(function(orderedItems, index) {totalPrice += orderedItems});
...
//     const nemes = users.map(user => user.name);
//    return nemes;
//   };
...
// const getTotalFriendCount = users => users.reduce((acc, user) => [...acc, ...user.friends],
//  []).length;
